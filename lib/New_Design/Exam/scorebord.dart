...
import 'ReviewExam/quizelist.dart';
import 'lavelboard.dart';

class ExamScoreboardPage extends StatefulWidget {
  ...
  @override
  State<ExamScoreboardPage> createState() => _ExamScoreboardPageState();
}

class _ExamScoreboardPageState extends State<ExamScoreboardPage> {
            ...
            InkWell(
              onTap: () {
                Navigator.push(
                    context,
                    MaterialPageRoute(
                        builder: ((context) => ReviewQuizeListPage(
                              name: widget.name,
              ...
              InkWell(
                onTap: () {
                  Navigator.push(
                      ...
                      MaterialPageRoute(
                          builder: ((context) => ExamLavelBoardPage(
                                subjectid: widget.quizesubjectid,
