...
class PaidCoursePage extends StatefulWidget {
  ...
  const PaidCoursePage({Key? key, required this.valueHide}) : super(key: key);

  @override
  State<PaidCoursePage> createState() => _PaidCoursePageState();
}
                ...
                children: [
                  ...
                  Expanded(
                    child: GridView.builder(
                        itemCount: provider.paidCourse!.data!.length,
                        ...
                        itemBuilder: ((context, index) {
                          var data = provider.paidCourse!.data![index];
                          return InkWell(
                            onTap: () {
                              // !valueHide
                              //     ? Navigator.push(
                              ...
                              Navigator.push(
                                  context,
                                  MaterialPageRoute(
                                      builder: (_) => PaidCourseDetails(
                                            paidcourseid: data.id.toString(),
                                            couresename: data.courseName!,
                                          )));
                            },
                            child: Stack(
                              fit: StackFit.expand,
