...
class PaidCoursebuypage extends StatefulWidget {
  final String paidcourseid;
  final PaidCoursedetails paidCoursedetails;
  const PaidCoursebuypage(
      {Key? key, required this.paidcourseid, required this.paidCoursedetails})
      : super(key: key);

  @override
  State<PaidCoursebuypage> createState() => _PaidCoursebuypageState();
}

class _PaidCoursebuypageState extends State<PaidCoursebuypage> {
  ...
  Future orderpaidcourse() async {
    ...
    await HttpPAidCourse().paidcourseorder(
        amount: amount.text,
        number: yournumber.text,
        payment_number: payment_number.text,
  ...
  @override
  void initState() {
    amount.text = widget.paidCoursedetails.data!.price!;
    loaddata();
    super.initState();
  }
                                  ...
                                  Container(
                                    ...
                                    child: ClipRRect(
                                      ...
                                      child:
                                          ...
                                          // ),
                                          Image.network(
                                        '$imageurl${widget.paidCoursedetails.data!.image}',
                                        fit: BoxFit.cover,
                                      ),
                                    ),
                                  ),
                                  ...
                                  Flexible(
                                    child: Column(
                                      ...
                                      children: [
                                        ...
                                        Text(
                                          "৳ ${widget.paidCoursedetails.data!.price!}",
                                          style: TextStyle(
                                            color: Colors.black87,
                                            fontSize: 20.sp,
                                            fontWeight: FontWeight.w700,
