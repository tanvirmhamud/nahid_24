...
import 'live_class_buy.dart';

class LiveClassDetails extends StatefulWidget {
  final String liveclassid;
  final String couresename;
  const LiveClassDetails(
      {super.key, required this.liveclassid, required this.couresename});

  @override
  State<LiveClassDetails> createState() => _LiveClassDetailsState();
}
...
class _LiveClassDetailsState extends State<LiveClassDetails> {
  ...
  Future loaddata() async {
    ...
    await provider.getliveclassdetails(widget.liveclassid);
    await provider.getliveclassvideo(widget.liveclassid);
                                      ...
                                      children: [
                                        ...
                                        Column(
                                          ...
                                          children: [
                                            ...
                                            SizedBox(width: 6.h),
                                            Text(
                                              '${provider.liveClassdetails!.data!.duration} ঘন্টা',
                                              style: TextStyle(
                                  ...
                                  children: [
                                    Container(
                                      ...
                                      child: ClipRRect(
                                        ...
                                        child:
                                            ...
                                            // ),
                                            Image.network(
                                          "$imageurl${provider.liveClassdetails!.data!.instructorInfo!.first.image}",
                                          fit: BoxFit.cover,
                                        ),
                                      ),
                                    ),
                                    ...
                                    Expanded(
                                      child: Column(
                                        ...
                                        children: [
                                          Text(
                                            provider.liveClassdetails!.data!
                          ...
                          child: MaterialButton(
                              onPressed: () {
                                Navigator.push(
                                    context,
                                    MaterialPageRoute(
                                        builder: (_) => LiveClassbuypage(
                                              classid: widget.liveclassid,
                                              liveClassdetails:
                                                  provider.liveClassdetails!,
                                            )));
                              },
