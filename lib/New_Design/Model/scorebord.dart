...
import 'ReviewModel/model_question.dart';
import 'lavelboard.dart';

class ModelScoreboardPage extends StatefulWidget {
  ...
  @override
  State<ModelScoreboardPage> createState() => _ModelScoreboardPageState();
}

class _ModelScoreboardPageState extends State<ModelScoreboardPage> {
              ...
              InkWell(
                onTap: () {
                  Navigator.push(
                      context,
                      MaterialPageRoute(
                          builder: ((context) => ModelLavelBoardPage(
