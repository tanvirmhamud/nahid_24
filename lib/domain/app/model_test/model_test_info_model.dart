...
class ModelTestInfoModel extends Equatable {
  final int id;
  ...
  factory ModelTestInfoModel.fromMap(Map<String, dynamic> map) {
    return ModelTestInfoModel(
      id: map['id'] as int,
  ...
  factory ModelTestInfoModel.fromJson(String source) =>
      ModelTestInfoModel.fromMap(json.decode(source) as Map<String, dynamic>);
  ...
  factory ModelTestInfoModel.init() => const ModelTestInfoModel(
      id: 0,
      question: '',
      option1: '',
      option2: '',
